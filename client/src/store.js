...
const lenders = [
    { name: 'DIABLOSATORU', type: 'mistnest', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
    ...
    { name: 'DIABLOSATORU', type: 'trap', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
